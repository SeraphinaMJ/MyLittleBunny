...
bool
BE::JsonReader::readFile(const std::string& filePath_, Json::Value& data_)
{
...
bool
BE::JsonReader::fileExists(std::string filepath_)
{
    struct stat buffer;
...
std::list<BE::Prop::Animation::keyFrame>
BE::JsonReader::getListAsKeyFrame(const Json::Value & data_)
{
...
BE::JsonReader::getArrayAsValue(const Json::Value& data_)
{
...
BE::JsonReader::getArrayAsString(const Json::Value& data_)
{
...
std::vector<glm::vec2>
BE::JsonReader::getArrayAsVec2(const Json::Value& data_)
{
...
std::vector<glm::vec3>
BE::JsonReader::getArrayAsVec3(const Json::Value& data_)
{
...
std::vector<glm::vec4>
BE::JsonReader::getArrayAsVec4(const Json::Value& data_)
{
...
int
BE::JsonReader::getFieldAsInt(const Json::Value& data_)
{
    int retVal = 0;
...
float
BE::JsonReader::getFieldAsFloat(const Json::Value& data_)
{
    float retVal = 0.0f;
...
std::string
BE::JsonReader::getFieldAsString(const Json::Value& data_)
{
...
bool
BE::JsonReader::getFieldAsBool(const Json::Value& data_)
{
    bool retVal = false;
...
glm::vec2
BE::JsonReader::getFieldAsVec2(const Json::Value& data_)
{
...
glm::ivec2
BE::JsonReader::getFieldAsIVec2(const Json::Value& data_)
{
...
glm::vec3
BE::JsonReader::getFieldAsVec3(const Json::Value& data_)
{
...
glm::ivec3
BE::JsonReader::getFieldAsIVec3(const Json::Value& data_)
{
...
glm::vec4
BE::JsonReader::getFieldAsVec4(const Json::Value & data_, const float defaultValue_)
{
...
glm::ivec4
BE::JsonReader::getFieldAsIVec4(const Json::Value & data_)
{
